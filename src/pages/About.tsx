...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="bg-slate-950 text-white mt-55 py-20 md:py-10"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              combine my love for creativity with the logic of programming. I
              don't just write code; I build digital experiences that solve
              real-world problems.
            </p>
            <p className="text-gray-400 leading-relaxed">
              I am exploring new UI trends, contributing to open-source
              projects, or perfecting my coffee-to-code ratio. I believe in
